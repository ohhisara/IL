...
happyExpList = Happy_Data_Array.listArray (0,70) ([16848,515,0,0,112,8,0,512,14848,53352,33601,6670,0,62368,32774,11,1,16,26682,16848,3715,26,0,0,0,41192,1857,13,53256,889,0,53364,0,33280,59395,416,736,0,0,0,0
	])
